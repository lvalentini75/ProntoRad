-- Migration: Fix organizations table columns for RPC compatibility
-- Date: 2026-01-19 20:00:00
-- This adds missing columns (if needed) and updates RPC functions
...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE organizations ADD COLUMN address TEXT DEFAULT '';
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE organizations ADD COLUMN latitude DOUBLE PRECISION NULL;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE organizations ADD COLUMN longitude DOUBLE PRECISION NULL;
  END IF;
END $$;

-- ============================================================================
-- Update get_booking_with_user RPC function
-- ============================================================================
