-- Migration: Update RPC function to use organization_id instead of facility_id
-- Date: 2026-01-17 00:00:00
-- This migration updates the create_booking_bypass_rls function to use organization_id
...
-- Create the updated RPC function with organization_id
...
BEGIN
  ...
  -- Insert booking with organization_id
...
'Creates a booking using organization_id (Struttura = Organizzazione). Bypasses RLS for org_admins.';
